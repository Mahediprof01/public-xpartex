...
import { AuthorStats } from "@/components/authors/author-stats-overview"
...
export default function AuthorsPage() {
  ...
  const expertiseAreas = [
    { id: "all", name: "All Expertise", count: 15 },
    { id: "manufacturing", name: "Manufacturing", count: 6 },
    { id: "business", name: "Business Strategy", count: 4 },
    { id: "quality-control", name: "Quality Control", count: 3 },
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Discover books from industry professionals and thought leaders
            </motion.p>
            ...
            >
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder="Search authors by name, expertise, or experience..."
                  value={searchQuery}
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-gray-900">75K+</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">
                  {selectedExpertise === "all" ? "All Authors" : expertiseAreas.find(a => a.id === selectedExpertise)?.name}
                </h2>
                <p className="text-gray-600 mt-1">
                  Showing {expertiseAreas.find(a => a.id === selectedExpertise)?.count || 15} authors
                </p>
              </div>
            </div>
