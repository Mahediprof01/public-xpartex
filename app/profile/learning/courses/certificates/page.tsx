  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-sky-500 to-cyan-400 rounded-xl p-6 text-white">
        ...
        <p className="text-sky-100">View and download your earned certificates</p>
      </div>
        ...
        <Card className="bg-gradient-to-br from-sky-50 to-cyan-100 border-sky-200">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-sky-600">Earned</p>
                <p className="text-xl font-bold text-sky-900">2</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-cyan-900">1</p>
              </div>
            </div>
          </CardContent>
        </Card>
