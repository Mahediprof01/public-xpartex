...
const services = [
  {
    id: "TS-001",
    name: "Inspection & QC",
    desc: "Pre-shipment inspection and quality checks",
    price: "Contact for quote",
  },
  {
    id: "TS-002",
    name: "Freight Forwarding",
    desc: "Door-to-door shipping solutions",
    price: "Contact for quote",
  },
  {
    id: "TS-003",
    name: "Trade Financing",
    desc: "Payment assurance solutions",
    price: "Contact for quote",
  },
];
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Value-added services to support your sourcing
            </p>
          </div>
