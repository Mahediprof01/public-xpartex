            ...
            <CardContent>
              <Tabs defaultValue="all" className="space-y-4">
                <TabsList>
                  ...
                  <TabsTrigger value="confirming">Confirming ({ordersByStatus.confirming.length})</TabsTrigger>
                  <TabsTrigger value="unpaid">Unpaid ({ordersByStatus.unpaid.length})</TabsTrigger>
                  <TabsTrigger value="preparing">Preparing ({ordersByStatus.preparing.length})</TabsTrigger>
                  <TabsTrigger value="shipping">Shipping ({ordersByStatus.shipping.length})</TabsTrigger>
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm font-semibold text-blue-600">${order.totalAmount.toFixed(2)}</p>
                                    </div>
                                    <div>
                                  ...
                                  <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2 text-sm text-gray-500">
                                      {order.status === "delivered" && (
                                        <span className="text-green-600">✓ Delivered on {order.deliveryDate}</span>
                                      )}
                                    </div>
