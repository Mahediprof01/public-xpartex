...
export function AuthorHero({ author }: AuthorHeroProps) {
  const breadcrumbs = [
    ...
    { label: author.name, href: "#", current: true }
  ]
    ...
    <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          {/* Left Column - Author Image and Basic Info */}
          <motion.div
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                  <CardContent className="p-4 text-center">
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-2xl font-bold text-white">{author.rating}</span>
                    </div>
                ...
                <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                  <CardContent className="p-4 text-center">
                    ...
                    <p className="text-xs text-green-200">Readers</p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/10 backdrop-blur-sm border-white/20">
                  <CardContent className="p-4 text-center">
                    <div className="flex items-center justify-center mb-2">
                      ...
                      <span className="text-xl font-bold text-white">{author.totalBooks}</span>
                    </div>
                    <p className="text-xs text-purple-200">Books</p>
                  </CardContent>
                </Card>
              </div>
